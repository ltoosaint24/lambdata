...
setup(
  ...
  version = '01.123',      # Start with a small number and increase it with every change you make
  ...
  download_url = 'https://github.com/ltoosaint24/lambdata-ltoussaint-/archive/refs/tags/v_01.123.tar.gz',    # I explain this later on
